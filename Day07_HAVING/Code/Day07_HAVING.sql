/* Daily Challenge: Identify services that refused more than 100 patients in total and
...
-- DAY 7 Practice question: 1. Find services that have admitted more than 500 patients in total.
USE hospital;
SELECT service,
